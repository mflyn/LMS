...
jest.mock('../../models/Announcement', () => {
  ...
  // 添加静态方法
  mockAnnouncement.find = jest.fn().mockReturnThis();
  mockAnnouncement.findById = jest.fn().mockReturnThis();
  mockAnnouncement.findByIdAndUpdate = jest.fn().mockReturnThis();
  mockAnnouncement.findByIdAndDelete = jest.fn().mockReturnThis();
  mockAnnouncement.countDocuments = jest.fn().mockResolvedValue(10);
  mockAnnouncement.sort = jest.fn().mockReturnThis();
  mockAnnouncement.skip = jest.fn().mockReturnThis();
  mockAnnouncement.limit = jest.fn().mockReturnThis();
  mockAnnouncement.populate = jest.fn().mockReturnThis();
  mockAnnouncement.exec = jest.fn();
