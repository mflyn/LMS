    ...
    return (
      <View style={styles.profileInfoContainer}>
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{profile?.name || user?.username || '未设置'}</Text>
        </View>
        <View style={styles.infoRow}>
          <Text style={styles.infoLabel}>关系</Text>
          <Text style={styles.infoValue}>{profile?.relation || '未设置'}</Text>
        </View>
        <View style={styles.infoRow}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>{profile?.address || '未设置'}</Text>
        </View>
      </View>
    );
  };
      ...
      <View style={styles.header}>
        <View style={styles.avatarContainer}>
          ...
          <View style={styles.userInfo}>
            <Text style={styles.userName}>{profile?.name || user?.username || '家长用户'}</Text>
