...
| `FR-MISTAKE-001` | 6 | 6 | 10.4 | 4.6, Task 6 design 6/6.1 | mistakes | `analytics-service` planned | `TC-T6-MISTAKE-001`-`014` designed | PLANNED_TASK_5_PLUS | approved Task 6 design/test review; implementation pending |
| `FR-REPORT-001` | 6 | 6 | 10.4 | 4.7, ADR-0001/0007, Task 6 design 7/8 | weekly reports | `analytics-service` and source event projections planned | `TC-T6-REPO-001`-`007`, `TC-T6-REPORT-001`-`018` designed | PLANNED_TASK_5_PLUS | approved Task 6 design/test review; implementation pending |
| `FR-MEDIA-001` | 6 | 6 | 9.11/10.4 | 4.8, Task 6 design 4/5 | media upload/access and business references | `resource-service` plus user/homework/analytics consumers planned | `TC-T6-MEDIA-001`-`008`, `011`-`018`, `TC-T6-MISTAKE-009`-`012`, `TC-T6-GW-003` designed | PLANNED_TASK_5_PLUS | approved Task 6 design/test review; implementation pending |
| `FR-MEDIA-002` | 6 | 6 | 9.11/10.4 | 4.8, Task 6 design 4.4 | media delete | `resource-service` planned | `TC-T6-MEDIA-009`-`010`, `TC-T6-MISTAKE-011` designed | PLANNED_TASK_5_PLUS | approved Task 6 design/test review; implementation pending |
...
| `NFR-PRIVACY-001` | 6 | 6 | 9.11/10.4 | 4.8, Task 6 design 4/9/10 | all media APIs | `resource-service` planned | `TC-T6-MEDIA-001`, `003`, `006`-`010`, `015`-`018`, `TC-T6-REG-002` designed | PLANNED_TASK_5_PLUS | approved Task 6 design/test review; implementation pending |
