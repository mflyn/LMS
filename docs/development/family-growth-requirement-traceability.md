...
| `FR-POINT-001` | 5 | 5 | 10.4 | 4.5, Task 5 design 4.2/5 | knowledge points | `KnowledgePoint.js`, `knowledgePoints.js`, `growthAccess.js` | `TC-T5-POINT-001`-`008` pass | COVERED | closed Task 5 implementation review |
| `FR-MISTAKE-001` | 6 | 6 | 10.4 | 4.6 | mistakes | `analytics-service` planned | planned Task 6 | PLANNED_TASK_5_PLUS | none |
| `FR-REPORT-001` | 6 | 6 | 10.4 | 4.7, ADR-0001/0007 | weekly reports | `analytics-service` planned | planned Task 6 cutoff/freeze tests | PLANNED_TASK_5_PLUS | none |
| `FR-MEDIA-001` | 6 | 6 | 9.11/10.4 | 4.8 | media upload/access | `resource-service` planned | planned Task 6 media authorization/signature/EXIF tests | PLANNED_TASK_5_PLUS | none |
| `FR-MEDIA-002` | 6 | 6 | 9.11/10.4 | 4.8 | media delete | `resource-service` planned | planned Task 6 soft-delete/retention tests | PLANNED_TASK_5_PLUS | none |
...
| `FR-REWARD-002` | 5 | 5 | 10.4 | 4.8, ADR-0005, Task 5 design 8 | rewards | `Reward.js`, `StarLedgerGuard.js`, `rewards.js`, `starLedgerService.js` | `TC-T5-REWARD-001`-`011` pass | COVERED | closed Task 5 implementation review |
| `FR-NOTIFY-001` | 7 | 7 | 10.4 | 3.1, ADR-0001 | notifications | `notification-service` planned | planned Task 7 | PLANNED_TASK_5_PLUS | none |
| `FR-NOTIFY-002` | 7 | 7 | 9.10/10.4 | 4.8 | notification settings | `notification-service` planned | planned Task 7 timezone/dedup/settings tests | PLANNED_TASK_5_PLUS | none |
...
| `NFR-SEC-003` | 5 | 5 | 10.4 | Task 5 design section 6 | internal star award | `serviceCredential.js`, `internalStars.js`, `starAwardClient.js`, gateway allowlist | `TC-T5-STAR-001/002/006`, `TC-T5-GW-002` pass | COVERED | closed Task 5 implementation review |
...
| `NFR-DATA-002` | 5 | 5 | 10.4 | Task 5 design sections 7/8, ADR-0005 | task award and reward redemption | immutable ledger, guard transaction, recoverable confirmation saga | `TC-T5-STAR-003`-`005`, `TC-T5-REWARD-005`-`011`, `TC-T5-SAGA-001`-`005` pass | COVERED | closed Task 5 implementation review |
| `NFR-PRIVACY-001` | 6 | 6 | 9.11/10.4 | 4.8 | all media APIs | `resource-service` planned | planned Task 6 private URL/scope/retention/log-redaction tests | PLANNED_TASK_5_PLUS | none |
