...
| `FR-MISTAKE-001` | 6 | 6 | 10.4 | 4.6, Task 6 design 6/6.1 | mistakes | `FamilyMistake.js`, `FamilyMistakeStateEvent.js`, `familyMistakes.js`, `familyMistakeMediaService.js` | `TC-T6-MISTAKE-001`-`014` pass; Task 6 gate pass | COVERED | closed Task 6 implementation review and final gate |
