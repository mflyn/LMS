...
- [x] **Step 1: Write failing import/startup test**
...
- [x] **Step 3: Implement `createApp` and explicit `startServer`**
...
- [x] **Step 1: Write failing `TC-T7-SETTINGS-001` through `004`**
...
- [x] **Step 3: Implement model and routes**
...
- [x] **Step 1: Write failing `TC-T7-NOTIFY-001` through `012`**
...
- [x] **Step 2: Run family regression**
