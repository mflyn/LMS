...
| 领域 | 权威入口 | 内容 |
| --- | --- | --- |
| 产品 | [家庭成长跟踪 PRD](./product/family-learning-tracker.md) | 用户、德智体美劳范围、38 项需求和非目标 |
...
├── superpowers/   # Task 5-12 已批准的设计与实施计划
...
38 项需求集合、实现与设计状态、基线证据以及三个 README 入口中的真实命令和过时模板内容。
